...
// func NewBigQueryApi(ctx context.Context, ProjectID string) *BigQueryApi {
func NewBigQueryApi(ctx context.Context, ProjectID string, DatasetID string) *BigQueryApi {
	bq := new(BigQueryApi)
	...
	if err != nil {
		fmt.Print("new client create error.")
		return nil
	}
...
func (bq *BigQueryApi) Query(ctx context.Context, sql string) [][]bigquery.Value {
...
func (bq *BigQueryApi) InsertFromCsv(ctx context.Context, tableName string, gcsBucketName string, gcsObjectPath string, optionsInsertFromCsv ...OptionsInsertFromCsv /*, schema bigquery.Schema*/) error {
